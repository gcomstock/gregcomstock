          ...
          <div className='SiteFooter__contentWrap'>
            ...
            <div className='SiteFooter__content__col'>
              <p>
                ...
                always keeps the user experience in mind, and can talk at length with creatives about the technical costs of
                design decisions, <a href='https://www.linkedin.com/in/gregcomstock/' target='_blank'>we should talk</a>!
              </p>
            </div>
          </div>
        </div>
